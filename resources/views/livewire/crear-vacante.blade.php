<form class="md:w-9/12 space-y-5" novalidate wire:submit.prevent="crearVacante">
    ...
    <div class="flex flex-wrap -mx-2 mb-2">
        ...
        <div class="w-full md:w-1/2 px-2 mb-3">
            <div class="space-y-2 ">
                ...
                <x-text-input id="imagen" accept="image/*" class="block mt-1 w-full" type="file" wire:model="imagen" required autofocus autocomplete="username" />
                <div class="my-5 w-1/3">
                    @if ($imagen)
                        <img class="" src="{{$imagen->temporaryUrl()}}" alt="">
                    @endif
                </div>
